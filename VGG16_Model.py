...
print('Loading Data..')
X_train = numpy.load('Train_Data_C.npy')
X_test = numpy.load('Test_Data_C.npy')
X_valid = numpy.load('Valid_Data_C.npy')
y_train = numpy.load('Train_Label_C.npy')
y_test = numpy.load('Test_Label_C.npy')
y_valid = numpy.load('Valid_Label_C.npy')
